        ...
        <div name="about" className='w-full h-auto bg-gradient-to-b from-gray-800 to-black text-white'>
            <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-auto'>
                ...
                <p data-aos="slide-up" data-aos-duration="500" className='text-xl mt-5 ease-in fade-in'>
                    I embarked my journey as a BCA Computer Application student at IMT Faridabad College in 2020. Along the way, I fearlessly explored various fields, Content Creation, Freelancing, and Entrepreneurship. I delved into the world of cutting-edge technologies, such as Python, Html, Css, Javascript, React, Nodejs and Flutter. I also took my passion for technology and leadership to new heights by co-establishing E-Commerce website for Indian Government and the landing page for the College. 
                </p>
                <br />
                <p data-aos="slide-up" data-aos-duration="500" className='text-xl mt-5 ease-in fade-in'>
                    In a constant pursuit of sharing knowledge and fostering growth, I've organized numerous technical workshops, imparting valuable insights on technologies like Python, Full Stack Developer to aspiring learners. With a commitment to personal development and a drive for making a positive impact within the tech community.
                </p>
                {/* <br />
                ...
                <div data-aos="zoom-in" data-aos-duration="500" className='mb-20 fade-in flex mx-auto items-center justify-center hover:scale-105 duration-300 rounded bg-gradient-to-b from-cyan-500 to-blue-500 lg:w-1/5 md:w-1/5 w-2/4 h-10 text-center cursor-pointer mt-10 gap-2'>
                    ...
                    <a href="https://drive.google.com/file/d/1CmqflNXNYCNIo0rVK83nx_1RwnE-ozrr/view?usp=drivesdk" download>Download CV</a>
                </div>
            </div>
        </div>
    )
